...
# Date: 12/07/2021
# Purpose: This is a class set to do analyses on Spikes and LFPs from data read in by pyeCAP
# Revision History: N/A
# Class usage: Inherits _TSClass operations.
#--------------------------------------------------------------------------------------------------------------------------------
...
from scipy.signal import medfilt, find_peaks, savgol_filter, ellip
...
class spike(_EpochData):
    """
    Class for processing of single or multiunit spike data from penetrating electrode arrays
    """
    def __init__(self, EPhys, stim):
        """
        ...
        self.lowFreq = 300.
        self.highFreq = 5000.
        self.filt_data = Ephys.filter_powerline()
        self.filt_data = self.filt_data.filter_Spike()       #300-5000 Hz Elliptic bandpass filter for spikes
        

class LFPs(_TsData):
    """
    Class for processing of LFPs as recorded from ECoG arrays or penetrating electrode arrays
    """
    def __init__(self, data, *args, stores=None, order=True, rz_sample_rate=None, si_sample_rate=None, sample_delay=None,
        ...
        ** kwargs : KeywordArguments
        ...
        """
        # call superclass spike for inheritence from the superclass
        self.exp_path = data
        # Work with file path
